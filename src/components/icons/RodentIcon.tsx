type RodentIconProps = {
  className?: string;
};

/** Material Design Icons rodent mark. @see https://www.shadcn.io/icon/mdi-rodent */
export default function RodentIcon({ className }: RodentIconProps) {
  return (
    <svg
